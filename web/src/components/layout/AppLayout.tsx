...
export default function AppLayout() {
  ...
  return (
    <div className="h-full flex overflow-hidden relative bg-bg text-text">
      <Sidebar />
      <main className="flex-1 min-h-0 min-w-0 overflow-y-auto overflow-x-hidden bg-[radial-gradient(circle_at_top_right,rgba(221,170,83,0.12),transparent_34%),linear-gradient(180deg,#092E24_0%,#051A10_38%)]">
        <div className="p-8">
